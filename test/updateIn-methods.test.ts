...
describe('edit method calls', () => {
  ...
  describe('Array methods', () => {
    it('should support push method', () => {
      const obj = { items: ['a', 'b'] }
      const result = edit(obj).items.push('c')
    ...
    it('should support multiple push arguments', () => {
      const obj = { items: [1, 2] }
      const result = edit(obj).items.push(3, 4, 5)
    ...
    it('should support pop method', () => {
      ...
      const result = edit(obj).items.pop()
    ...
    it('should support shift method', () => {
      const obj = { items: ['a', 'b', 'c'] }
      const result = edit(obj).items.shift()
    ...
    it('should support unshift method', () => {
      const obj = { items: ['b', 'c'] }
      const result = edit(obj).items.unshift('a')
    ...
    it('should support multiple unshift arguments', () => {
      const obj = { items: ['d'] }
      const result = edit(obj).items.unshift('a', 'b', 'c')
    ...
    it('should support splice method', () => {
      ...
      const result = edit(obj).items.splice(1, 2, 'x', 'y')
    ...
    it('should support sort method', () => {
      ...
      const result = edit(obj).items.sort()
    ...
    it('should support sort with compareFn', () => {
      ...
      const result = edit(obj).items.sort((a, b) => b - a)
    ...
    it('should support reverse method', () => {
      const obj = { items: ['a', 'b', 'c'] }
      const result = edit(obj).items.reverse()
    ...
    it('should support concat method (immutable)', () => {
      const obj = { items: ['a', 'b'] }
      const result = edit(obj).items.concat(['c', 'd'])
    ...
    it('should support slice method (immutable)', () => {
      const obj = { items: ['a', 'b', 'c', 'd'] }
      const result = edit(obj).items.slice(1, 3)
    ...
    it('should support map method (immutable)', () => {
      ...
      const result = edit(obj).items.map((x) => x * 2)
    ...
    it('should support filter method (immutable)', () => {
      ...
      const result = edit(obj).items.filter((x) => x % 2 === 0)
    ...
    it('should work with nested arrays', () => {
      ...
      const result = edit(obj).data.items.push('c')
  ...
  describe('Set methods', () => {
    it('should support add method', () => {
      ...
      const result = edit(obj).tags.add('c')
    ...
    it('should support add method with duplicate', () => {
      const obj = { tags: new Set(['a', 'b']) }
      const result = edit(obj).tags.add('b')
    ...
    it('should support delete method', () => {
      ...
      const result = edit(obj).tags.delete('b')
    ...
    it('should support delete method with non-existent value', () => {
      const obj = { tags: new Set(['a', 'b']) }
      const result = edit(obj).tags.delete('c')
    ...
    it('should support clear method', () => {
      const obj = { tags: new Set(['a', 'b', 'c']) }
      const result = edit(obj).tags.clear()
    ...
    it('should work with nested Sets', () => {
      ...
      const result = edit(obj).data.tags.add('typescript')
  ...
  describe('Map methods', () => {
    it('should support set method', () => {
      ...
      const result = edit(obj).config.set('debug', true)
    ...
    it('should support set method overwriting existing', () => {
      ...
      const result = edit(obj).config.set('theme', 'light')
    ...
    it('should support delete method', () => {
      ...
      const result = edit(obj).config.delete('debug')
    ...
    it('should support delete method with non-existent key', () => {
      const obj = { config: new Map([['theme', 'dark']]) }
      const result = edit(obj).config.delete('nonexistent')
    ...
    it('should support clear method', () => {
      ...
      const result = edit(obj).config.clear()
    ...
    it('should work with nested Maps', () => {
      ...
      const result = edit(obj).data.config.set('debug', true)
    ...
    it('should support chained Map operations in edit', () => {
      ...
      const result = edit.batch(obj, (draft) => {
        edit(draft).config.set('theme', 'light')
        edit(draft).config.set('debug', true)
        edit(draft).config.delete('old')
      })
  ...
  describe('Complex scenarios', () => {
    it('should handle mixed collection types', () => {
      ...
      const result = edit.batch(obj, (draft) => {
        edit(draft).users.push('charlie')
        edit(draft).tags.add('moderator')
        edit(draft).config.set('debug', true)
      })
    ...
    it('should handle nested collections', () => {
      ...
      const result = edit.batch(obj, (draft) => {
        edit(draft).data.lists[key]('todo').push('task3')
        edit(draft).data.tags.add('urgent')
      })
    ...
    it('should handle array of Sets', () => {
      ...
      const result = edit(obj).permissions[0].add('execute')
    ...
    it('should handle Map of arrays', () => {
      ...
      const result = edit(obj).groups[key]('users').push('dave')!
    ...
    it('should maintain immutability across operations', () => {
      ...
      const result = edit.batch(obj, (draft) => {
        edit(draft).arr.push('c')
        edit(draft).set.add('z')
        edit(draft).map.set('new', 'data')
      })
  ...
  describe('Collection methods with optional properties', () => {
    it('should handle array methods on optional arrays', () => {
      ...
      const pushResult = edit(obj).items.push('new')
      const popResult = edit(obj).items.pop()
      const mapResult = edit(obj).items.map((x) => x.toUpperCase())
    ...
    it('should handle array methods when optional array exists', () => {
      ...
      const pushResult = edit(obj).items.push('c')
    ...
    it('should handle Set methods on optional Sets', () => {
      ...
      const addResult = edit(obj).tags.add('new')
      const deleteResult = edit(obj).tags.delete('old')
    ...
    it('should handle Map methods on optional Maps', () => {
      ...
      const setResult = edit(obj).config.set('key', 'value')
      const deleteResult = edit(obj).config.delete('key')
  ...
  describe('Collections within optional objects', () => {
    it('should handle arrays in optional parent objects', () => {
      ...
      const result = edit(obj).data.items.push('new')
    ...
    it('should handle maps in optional parent objects', () => {
      ...
      const result = edit(obj).config.settings.set('theme', true)
  ...
  describe('Advanced nested collection scenarios', () => {
    it('should handle Array of Maps with optional access', () => {
      ...
      const result = edit(obj).data[0][key]('metrics')((metrics) => ({
        ...metrics,
    ...
    it('should handle Map of Sets with method calls', () => {
      ...
      const result = edit(obj).permissions[key]('admin').add('delete')
    ...
    it('should handle deeply nested optional collections', () => {
      ...
      const result = edit(obj).level1.level2.data[key]('group1')[0].add(42)
    ...
    it('should handle Set of Maps with nested operations', () => {
      ...
      const result = edit.batch(obj, (draft) => {
        ...
        edit(draft).complexData.clear()
        maps.forEach((map) => edit(draft).complexData.add(map))
      })
