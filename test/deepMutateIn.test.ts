...
import { deepMutateIn } from '../bedit.mjs'

describe('deepMutateIn', () => {
  it('should mutate a top-level property with function that returns value', () => {
    ...
    const result = deepMutateIn(obj).name((name) => name.toUpperCase())
  ...
  it('should mutate a top-level property with function that returns undefined', () => {
    ...
    const result = deepMutateIn(obj)((person) => {
  ...
  it('should mutate a nested property with function', () => {
    ...
    const result = deepMutateIn(obj).user.profile.name((name) =>
      name.toUpperCase(),
    )
  ...
  it('should use deep clone by default', () => {
    ...
    const result = deepMutateIn(obj).user.profile.settings((settings) => {
  ...
  it('should handle mutation that returns a new value', () => {
    ...
    const result = deepMutateIn(obj).name((name) => name.toUpperCase() + ' DOE')
  ...
  it('should handle mutation that returns null', () => {
    ...
    const result = deepMutateIn(obj).name(() => null as any)
  ...
  it('should handle nested arrays', () => {
    ...
    const result = deepMutateIn(obj).data[0][1]((item) => {
  ...
  it('should handle complex object mutations', () => {
    ...
    const result = deepMutateIn(obj).user.profile((profile) => {
  ...
  it('should throw error when accessing property of null/undefined', () => {
    ...
    expect(() => {
      // @ts-expect-error
      deepMutateIn(obj).user.name((name) => name.toUpperCase())
  ...
  it('should handle concurrent calls', () => {
    ...
    const result1 = deepMutateIn(obj).name((name) => name.toUpperCase())
    const result2 = deepMutateIn(obj).name((name) => name.toLowerCase())
  ...
  it('should handle mutation of array elements', () => {
    ...
    const result = deepMutateIn(obj).users[0]((user) => {
  ...
  it('should handle mutation with return value overriding mutation', () => {
    ...
    const result = deepMutateIn(obj).name((name) => {
  ...
  it('should handle maps with mutations', () => {
    ...
    const result = deepMutateIn(obj).foo.key('bar')((value) =>
      value.toUpperCase(),
    )
  ...
  it('should handle nested maps with mutations', () => {
    ...
    const result = deepMutateIn(obj).data.key('users').key('user1')((user) => {
      user.name = user.name.toUpperCase()
      user.age += 5
    })
  ...
  it('should handle maps within arrays with mutations', () => {
    ...
    const result = deepMutateIn(obj)[0].bar.key('foo')((value) =>
      value.toUpperCase(),
    )
